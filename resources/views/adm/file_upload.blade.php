        ...
        <div class="panel-body">
            <form method="post" action="{{ route('upload') }}" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    <label for="titulo-album" class="col-sm-3 col-form-label" style="text-align: right;">Título do Álbum:</label>
                    <div class="col-md-4">
                        <input type="text" class="form-control" maxlength="34" id="titulo-album" name="titulo-album" required />
                    </div>
                </div>
                <div class="row">
                    <label for="file" class="col-sm-3 col-form-label" style="text-align: right;">Escolher Foto De Capa:</label>
                    <div class="col-md-6">
                        <input type="file" name="file-capa" id="file-capa" accept="image/*" required />
                    </div>
                </div>
                <div class="row">
                    <label for="file" class="col-sm-3 col-form-label" style="text-align: right;">Escolher Demais Fotos:</label>
                    <div class="col-md-6">
