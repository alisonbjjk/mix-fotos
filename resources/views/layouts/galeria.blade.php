...
<body>
    ...
    <footer class="page-footer font-small blue credits">
    	<div style="color: white;" class="footer-copyright text-center py-3">Order By
    		<a style="color: red;" target="blank" href="https://instagram.com/alison_bjj">Alison Tavares</a>
    	</div>
    </footer>
    <!-- Footer -->
